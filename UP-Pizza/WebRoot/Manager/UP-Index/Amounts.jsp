...
<script src="Manager/UP-Index/assets/laydate/laydate.js"
	type="text/javascript"></script>
<script src="Manager/UP-Index/assets/dist/echarts.js"></script>
<title>交易金额</title>
</head>
	...
	<div class="margin clearfix">
		<div class="amounts_style">
			...
			<div class="border clearfix">
				<span class="l_f"> <a href="/UP-Pizza/AmountsSelectServlet"
					class="btn btn-info">全部订单</a> <a href="/UP-Pizza/ShowTodayServlet"
					class="btn btn-danger">当天订单</a> <a href="/UP-Pizza/ShowMonthServlet"
		...
		option = {
			...
			series : [

					{
						name : '成交订单',
						type : 'bar',
						data : [ 20, 49, 70, 232, 26, 67, 136, 162, 36, 20, 64,
								33, 26, 67, 136, 162, 36, 20, 64, ]
					},
					{
						name : '失败订单',
						type : 'bar',
						data : [ 2, 5, 9, 4, 2, 7, 1, 1, 4, 1, 0, 3, 0, 0, 1,
								2, 6, 2, 6, ]
					},
					{
						name : '成交金额',
						type : 'line',
						yAxisIndex : 1,
						data : [ 2024, 2233, 3344, 4543, 6355, 1042, 2037,
								2346, 2305, 1654, 2120, 6542, 2656, 6547, 1346,
								2162, 3456, 4520, 6664, ]
					} ]
		};
