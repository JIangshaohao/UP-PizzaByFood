			...
			<div class="admin_modify_style" id="Personal">
				...
				<div class="xinxi">
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="用户名" id="website-title"
								value="${s.userName}" class="col-xs-7 text_info name"
								disabled="disabled"> &nbsp;&nbsp;&nbsp;<a
						...
						<div class="col-sm-9">
							...
							<div class="add_sex">
								<label><input name="form-field-radio" type="radio"
									class="ace " value="保密" checked="checked"><span
										class="lbl tid">保密</span></label>&nbsp;&nbsp; <label><input
									name="form-field-radio" type="radio" class="ace " value="男"><span
										class="lbl tid">男</span></label>&nbsp;&nbsp; <label><input
									name="form-field-radio" type="radio" class="ace " value="女"><span
										class="lbl tid">女</span></label>
							</div>
						</div>
					</div>
					<!-- <div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="移动电话" id="website-title"
								value="${s.birthday}" class="col-xs-7 text_info tel"
								disabled="disabled">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="电子邮箱" id="website-title"
								value="${s.tel}" class="col-xs-7 text_info email"
								disabled="disabled">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="生日" id="website-title"
								value="${s.address }" class="col-xs-7 text_info birthday"
								disabled="disabled">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="地址" id="website-title"
								value="${s.email }" class="col-xs-7 text_info address"
								disabled="disabled">
						</div>
					</div>
					<div class="form-group">
...
<script>
	...
	function save_info() {
		...
		if (num > 0) {
			...
			//alert($(".name").val());
			var tid = $(".ace:checked").val();
			//alert($(".ace:checked").val());
			$.ajax({
				url : "/UP-Pizza/UpdateStaffInfoServlet",
				type : "post",
				data : {
					"name" : $(".name").val(),
					"sex" : tid,
