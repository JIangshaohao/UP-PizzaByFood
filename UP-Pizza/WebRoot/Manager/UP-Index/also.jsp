...
<body>
							...
							<c:forEach items="${list}" var="i">
								<li class=""><label class="online"> </label> <a
									href="javascript:;"> <img class="cusimg"
										src="Manager/UP-Index/images/also/alsoimg/cusimg/${i.images}"></a><a
	...
	<script>
							...
							function() {
								...
								function callback(result) {
									...
									var row = "<div class='row cussRigth'><div class='col-sm-12 text-right'><span>"
											+ info
											+ "</span> <img src='Manager/UP-Index/images/also/alsoimg/staimg/${s.images}' style='width:30px;height:30px;'/></div></div>";
		...
		function load(obj) {
			...
			$.ajax({
				url : "/UP-Pizza/getAlsoCusInfoServlet01",
				type : "post",
				data : {
					"id" : id
				},
