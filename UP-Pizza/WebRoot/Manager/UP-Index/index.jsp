			...
			function() {
				...
				$('#Exit_system').on('click', function() {
					layer.confirm('是否确定退出系统？', {
						...
						location.href = "/UP-Pizza/Manager/Login.jsp";
...
<body>
	<div class="navbar navbar-default" id="navbar">
		...
		<div class="navbar-container" id="navbar-container">
			<div class="navbar-header pull-left">
				<a href="#" class="navbar-brand"> <small> <span
						style="color:#C1BDB3;position: relative;top: 20px;left: 20px;"><h1>
								<i style="font-family:'mv boli';">UP-Pizza</i> <i
									style="font-weight: bold;">管理系统</i>
							</h1></span>
				</small>
				</a>
				<!-- /.brand -->
				...
				<ul class="nav ace-nav">
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <span class="time"><em
								id="time"></em></span><span class="user-info"><small>您好！</small>${s.userName}</span>
							<i class="icon-caret-down"></i>
					</a>
						<ul
							class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
							<li><a href="javascript:void(0" name="Systems.jsp"
			...
			<div class="sidebar" id="sidebar">
				...
				<div id="menu_style" class="menu_style">
					<ul class="nav nav-list" id="nav_list">
						<li class="home"><a href="javascript:void(0)" name="home.jsp"
						...
						<li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="/UP-Pizza/InShowFoodServlet" title="产品类表"
									class="iframeurl"><i class="icon-double-angle-right"></i>产品类表</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="/UP-Pizza/ShowCDServlet" title="品牌管理" class="iframeurl"><i
						...
						<li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="transaction.jsp" title="交易情况" class="iframeurl"><i
										class="icon-double-angle-right"></i>交易情况</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="Order_Chart.jsp" title="交易订单（图）" class="iframeurl"><i
										class="icon-double-angle-right"></i>交易订单(图)</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="/UP-Pizza/SelectOrderAllServlet" title="订单管理"
									class="iframeurl"><i class="icon-double-angle-right"></i>订单管理</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="/UP-Pizza/AmountsSelectServlet" title="交易信息"
								...
								<li class="home"><a href="javascript:void(0)"
									name="/UP-Pizza/OutInfoPageServlet" title="退款管理"
						...
						<li><a href="#" class="dropdown-toggle"><i
								...
								class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
								<li class="home"><a id="uulist" href="javascript:void(0)"
									name="/UP-Pizza/CustPageServlet" title="用户列表" class="iframeurl"><i
								...
								<li class="home"><a href="javascript:void(0)"
									name="integration.jsp" title="用户记录管理" class="iframeurl"><i
						...
						<li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="/UP-Pizza/getAlsoCusServlet01" title="" class="iframeurl"><i
										class="icon-double-angle-right"></i>客服中心</a></li>
								<!-- <li class="home"><a href="javascript:void(0)"
							...
							<ul class="submenu">
								...
								<li class="home"><a href="javascript:void(0)"
									name="article_Sort.jsp" title="分类管理" class="iframeurl"><i
										class="icon-double-angle-right"></i>公告通知</a></li>
							</ul></li>
						<!-- <li><a href="#" class="dropdown-toggle"><i
					...
					<div>
						<div class="pull-left">
							<select id="skin-colorpicker" class="hide">
								<option data-skin="default" value="#D0D0D0">#D0D0D0</option>
								<option data-skin="skin-1" value="#222A2D">#222A2D</option>
								<option data-skin="skin-2" value="#C6487E">#C6487E</option>
								<option data-skin="skin-3" value="#438EB9">#438EB9</option>
							</select>
						</div>
						<span>&nbsp; 选择皮肤</span>
					</div>
	...
	<div class="footer_style" id="footerstyle">
		...
		<p class="l_f">版权所有：UP集团责任有限公司</p>
		<p class="r_f">全称:Unlimited Power 技术支持：姜少豪、李佳兴</p>
	</div>
	<!--修改密码样式-->
