...
<div class="Numbering">订单编号:<b>NJHDXJ201509-001</b></div></div>
 ...
 <!--收餐人信息-->
    <div class="Receiver_style">
     <div class="title_name">收餐人信息</div>
     <div class="Info_style clearfix">
        <div class="col-xs-3">  
         <label class="label_name" for="form-field-2"> 收餐人姓名： </label>
         <div class="o_content">张孝全</div>
        </div>
        <div class="col-xs-3">  
         <label class="label_name" for="form-field-2"> 收餐人电话： </label>
         <div class="o_content">16543432343</div>
        </div>
         <div class="col-xs-3">  
         <label class="label_name" for="form-field-2"> 收餐地址： </label>
     ...
     <div class="Info_style clearfix">
      <div class="col-xs-3">  
        ...
        <div class="col-xs-3">  
         ...
         <div class="col-xs-3">  
         <label class="label_name" for="form-field-2"> 外卖商家： </label>
    ...
    <div class="Logistics_style clearfix">
     <div class="title_name">骑手送餐信息</div>
                    ...
                    <div class="mh-list">
                        <ul>
                            ...
                            <li>
                                ...
                                <p>泉州市速递物流分公司南区电子商务业务部已收餐，（揽投员姓名：王晨光;联系电话：<a href="tel:13774826403">13774826403</a>）</p>
                                <span class="before"></span><span class="after"></span></li>
                        </ul>
                    </div>
                </div>
