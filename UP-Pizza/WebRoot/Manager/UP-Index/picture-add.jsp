...
<link href="Manager/UP-Index/Widget/icheck/icheck.css" rel="stylesheet"
	type="text/css" />
<link href="Manager/UP-Index/Widget/webuploader/0.1.5/webuploader.css"
...
<body>
	...
	<div class="clearfix" id="add_picture">
		<div class="page_right_style">
			<div class="type_title">
				添加商品<span style="color: red;">(注:带*号为必填)</span>
			</div>
			<form action="AddFoodServlet" method="post"
				...
				<div class=" clearfix cl">
					...
					<div class="Add_p_s">
						<label class="form-label col-2"><span class="c-red">*</span>食物名：</label>
						<div class="formControls col-2">
							<input type="text" class="input-text" value="" placeholder=""
								id="foodName" name="foodName">
						</div>
					</div>

					<div class="Add_p_s">
						<label class="form-label col-2"><span class="c-red">*</span>每日制作额：</label>
						<div class="formControls col-2">
							<input type="text" class="input-text" value="" placeholder=""
								id="num" name="num">个
						</div>
					...
					<div class="Add_p_s">
						<label class="form-label col-2"><span class="c-red">*</span>所属类型：</label>
						<div class="formControls col-2">
							<span class="select-box"> <select class="select"
								name="foodNum" id="foodNum">
									<!-- 获取集合，遍历食物表类别 -->
									<%
										for (Type t : types) {
									%>
					...
					<div class="Add_p_s">
						<label class="form-label col-2"><span class="c-red">*</span>展示价格：</label>
						<div class="formControls col-2">
							<input type="text" class="input-text" value="" placeholder=""
								id="xprice" name="xprice">元
						</div>
					</div>
					<div class="Add_p_s">
				...
				<div class="clearfix cl">
					<label class="form-label col-2"><span class="c-red">*</span>内容摘要：</label>
					<div class="formControls col-10">
						<textarea name="info" id="info" cols="" rows="" class="textarea"
							placeholder="请填写食物的信息......来更好的吸引顾客吧！" datatype="*10-100"
				...
				<div class="clearfix cl">
					...
					<div class="formControls col-10">
						<div class="uploader-list-container">
							<div class="queueList">
								<input type="file" id="imagefile" onchange="getImage()" /> <br />
								<img id="img" src="Manager/UP-Index/food/" width="120px"
									height="100px" /> <input type="hidden" id="imgTxt"
									name="imageName" />
							</div>
				...
				<div class="clearfix cl">
					<div class="Button_operation">
						<button onclick="check()" class="btn btn-primary radius"
							type="submit" id="aa">
							<i class="icon-save "></i>保存
						</button>
						<!-- <butt?on onClick="article_save();"
	...
	<script src="Manager/js/jquery-1.12.4.js"></script>
	...
	<script type="text/javascript">
		$("#aa")
				.click(
						function() {
							...
							var xprice = $("#xprice").val();
							var num = $("#num").val();
							var OUtype = $("#OUtype").val();
							var foodNum = $("#foodNum").val();
							var imageName = $("#imgTxt").val();
							//alert(imageName);
							var info = $("#info").val();
							...
							if (foodName == "" || foodName == null
								...
								function upd(result) {
									if (result == "true") {
										//alert("表："+foodNum);
										window.location.href = "/UP-Pizza/SelectAllHanbao?fid="
												+ (parseInt(foodNum) - 1);
									}
		...
		/* function check() {
			...
			var info = $("#info").val();
			console.log(foodName);
			if (foodName == "" || foodName == null || yprice == ""
					|| yprice == null || xprice == "" || xprice == null
					|| num == "" || num == null || OUtype == ""
					|| OUtype == null || foodNum == "" || foodNum == null
					|| imageName == "" || imageName == null || info == ""
					|| info == null) {
				alert("添加的数据不完整!");
				return false;
			}
