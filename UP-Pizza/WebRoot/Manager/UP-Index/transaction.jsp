...
<body>
	<%
		...
		int ShibaiMoney = ps.selectAllNoDingdanNoMoney();
		request.setAttribute("ShibaiMoney", ShibaiMoney);
	%>
			...
			series : [
					{
						name : '所有订单',
						type : 'bar',
						data : [ 120, 49, 70, 232, 256, 767, 1356, 1622, 326,
								200, 164, 133 ],
						markPoint : {
							data : [ {
								type : 'max',
					...
					},
					{
						name : '代发货',
						type : 'bar',
						data : [ 26, 59, 80, 24, 87, 70, 175, 1072, 48, 18, 69,
								63 ],
						markPoint : {
							data : [ {
								name : '年最高',
