...
public class CustomerChowBreakfastServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public CustomerChowBreakfastServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<Food> food = dao.selectByPage(pageNum, pageSize);
		// 查询商品的总条数
		...
		// 6.跳转到主页面
		request.getRequestDispatcher("Customer/index-1.jsp").forward(request, response);
		out.flush();
		out.close();
	}
