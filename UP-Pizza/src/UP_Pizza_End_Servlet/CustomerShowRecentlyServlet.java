...
public class CustomerShowRecentlyServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public CustomerShowRecentlyServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		RecentlyRemoveDAO rce = new RecentlyRemoveDAO();
		ArrayList<RecentlyRemove> list = rce.showrecenRemove(customer.getId());
