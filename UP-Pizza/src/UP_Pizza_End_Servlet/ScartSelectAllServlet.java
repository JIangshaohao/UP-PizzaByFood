...
public class ScartSelectAllServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public ScartSelectAllServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String uid = (String) request.getSession().getAttribute("cus");
		ArrayList<Scart> list = cs.selectAll(uid);
