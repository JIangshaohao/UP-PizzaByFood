...
public class SelectInfoByTimeDid extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public SelectInfoByTimeDid() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<Dingdan> list=o.selectTimeByThings(dingdanid, start);
		request.setAttribute("listas", list);
		request.getRequestDispatcher("Manager/UP-Index/Orderform.jsp").forward(request, response);
		out.flush();
		out.close();
	}
